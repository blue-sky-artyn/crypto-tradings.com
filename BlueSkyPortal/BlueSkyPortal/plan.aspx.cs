...
<<<<<<< HEAD
                    ...
                    if(id_plan1=="3")
                    {
                        s1 += "<p>Minimum amount:" + row3.Min_price + "$(trx)</p>";
                        s1 += "<p>Maximum amount:" + row3.Max_price + "$(trx)</p>";
                    }
                    ...
                    {
                        s1 += "<p>Minimum amount:" + row3.Min_price + "$(USDT trc20)</p>";
                        s1 += "<p>Maximum amount:" + row3.Max_price + "$(USDT trc20)</p>";
                    }
                 
                    s1 += "<p>Day:"+row3.Period+"</p>";
                    s1 += "<p>Percent:"+row3.Darsad+"</p>";
                    s1 += "<p>debt:" + row3.Debit + "</p>";
                    s1 += "<p>debt:" + row3.Desc_subplan + "</p>";
                    s1 += "</div>";
